...
export const ZODIAC_ARTICLES: ZodiacArticle[] = [
  {
    ...
    coverImage: '/illustrations/personality-hero-neutral.png',
...
以上内容仅供娱乐与自我探索，不构成任何专业建议。`,
  },
  {
    ...
    coverImage: '/illustrations/compatibility-couple-banner.png',
...
以上内容仅供性格与关系参考，请理性对待。`,
  },
  {
    ...
    coverImage: '/illustrations/annual-hero.png',
...
以上内容仅供生活规划参考，不构成投资、医疗或法律建议。`,
  },
  {
    ...
    coverImage: '/illustrations/quicktest-crystal.png',
...
StarLoom 的天象相关内容同样定位为文化参考与自我觉察，请理性使用。`,
  },
  {
    ...
    coverImage: '/illustrations/chat-advisor.png',
